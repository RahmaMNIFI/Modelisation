...
#python create_patches_fp.py --source "/media/rahma/CA78-56E6/" --save_dir "/home/rahma/Téléchargements/CLAM-master/resultats" --patch_size 256 --seg --patch --stitch
#python create_patches_fp.py --source "/media/rahma/CA78-56E6/" --save_dir "/home/rahma/Téléchargements/CLAM-master/images/" --patch_size 256 --seg --patch --stitch